...
def main():
    ...
    canvas.pack()
    bg = PhotoImage(file='./imagenes/mapa.png')
    logo = PhotoImage(file='./imagenes/logo.png')
    canvas.create_image(450, 454, image=bg)  # Establecer mapa.png como fondo.
    canvas.create_image(185, 175, image=logo)
    # Decoraciones.
    #canvas.create_rectangle(15, 80, 320, 270)
    ...
    # Botones
    b1 = tkinter.Button(root, text="Calcular camino",fg = "#ffffff", bg = "#000000",command=dale)
    b1.place(x=50, y=195)
    ...
    b3 = tkinter.Button(root, text="Seleccionar origen",fg ="#ffffff",bg="#000000", command=pick_origen)
    b3.place(x=225, y=132)
    b4 = tkinter.Button(root, text="Seleccionar destino",fg ="#ffffff", bg="#000000",command=pick_destino)
    b4.place(x=225, y=162)
